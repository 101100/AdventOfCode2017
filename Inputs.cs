namespace AdventOfCode2017
{
    ...
    {
        public const string Day1 = "";

        public const string Day2 = @"409	194	207	470	178	454	235	333	511	103	474	293	525	372	408	428
...
3858	202	1141	3458	2507	239	199	4400	3713	3980	4170	227	3968	1688	4352	4168";
        ...
        public const string Day4 = @"sayndz zfxlkl attjtww cti sokkmty brx fhh suelqbp
...
-40";
        ...
        public const string Day7 = @"mypyemv (1058) -> tdssotr, pebnvks, zaulju
snslv (48)
aytbgf (30)
mkcrsy (42)
shwcd (42)
...
tnmtz (26)";
        ...
        public const string Day8 = @"y inc 497 if n <= 3
ig inc -54 if es < 9
j dec 278 if low < 10
nm inc -531 if tr == 0
tq inc 537 if tq < 9
